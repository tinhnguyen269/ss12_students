...
<div class="container">
    ...
    <form action="/student?action=search" method="post">
        <div><input type="text" name="searchByName" placeholder="Nhập tên sinh viên">
    ...
    <table class="table table-hover">
        ...
        <c:forEach var="student" items="${students}" varStatus="status">
            <tr>
                ...
                <td>
                    <button class="btn btn-warning" onclick="window.location.href='/student?action=edit&id=${student.id}'">Sửa</button>
